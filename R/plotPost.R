...
#' @param HDItextPlace HDItextPlace.
#' @param xlab xlab
#' @param xlim xlim
#' @param yaxt yaxt
#' @param ylab ylab
...
#' @param col col
#' @param border border
#' @param showCurve showCurve
#' @param breaks breaks
#' @param ... Additional arguments passed to control plotting.
#'
...
plotPost <- function( values, id , groups, contrast, threshold = 0, cenTend=c("median","mode","mean")[1] ,
  ...
  if ( showCurve ) {
    par(xpd=NA)
    histinfo = hist( difference , plot=FALSE )
