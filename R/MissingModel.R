...
#'   Time2_vs_Time1 = Time2 - Time1,
#'   levels = groups_factor
#' )
#'
#' # Run the analysis
#' results <- BayesMissingModel(
#'   values = proteomics_matrix,
#'   groups = groups_factor,
#'   comparisons = my_contrasts,
#'   ROPE = c(-0.1, 0.1)
#' )
#'
#' # Access results for a specific contrast
#' treatment_results <- results$Treatment_vs_Control
